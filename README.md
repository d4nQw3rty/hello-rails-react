...
**Rails React** Is a Project to implement the backend with rails and the front end with React
...
```sh
  cd my-folder
  git clone git@github.com:d4nQw3rty/hello-rails-react.git
```
...
- Implmenet a front end framework **trying to implement the project with a front end framework**
...
Feel free to check the [issues page](https://github.com/d4nQw3rty/hello-rails-react/issues).
